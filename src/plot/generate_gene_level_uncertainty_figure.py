...
NPZ_PATH = PATHS["outputs_dir"] / "no_cf_0523" / "ugat_no_cf_uncertainty_sparse.eval.warm.npz"
...
def generate():
    ...
    fig.tight_layout()
    png_path = FIG_DIR / "gene_level_uncertainty_warm.png"
    pdf_path = FIG_DIR / "gene_level_uncertainty_warm.pdf"
